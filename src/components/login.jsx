  ...
  return (
    <div className="min-vh-100 d-flex flex-column align-items-center justify-content-center">
      <div className="text-center">
        ...
        >
          <svg className="me-2" style={{ width: '20px', height: '20px' }} viewBox="0 0 24 24">
            <path
              fill="currentColor"
      ...
      <footer className="mb-4 text-center ">
        <p>
          Made with ❤️ by <a href="https://harin-tech.netlify.app" target="_blank" rel="noopener noreferrer">Harin</a>
        </p>
      </footer>
    </div>
  );
